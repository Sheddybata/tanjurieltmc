    ...
    <div className="flex min-h-screen">
      <div className="hidden w-1/2 bg-gradient-to-br from-brand-700 via-brand-800 to-brand-950 lg:flex lg:flex-col lg:justify-between lg:p-12">
        ...
        <div>
          <h1 className="font-display text-4xl font-bold leading-tight text-white">
            Empowering communities through<br />accessible financial services
          </h1>
          <p className="mt-4 max-w-md text-lg text-brand-200">
            Secure, role-based platform for tellers, managers, and administrators.
          </p>
        ...
        <p className="text-sm text-brand-300">&copy; 2026 Tanjuriel Microfinance. All rights reserved.</p>
      </div>
      ...
      <div className="flex flex-1 items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <h2 className="font-display text-2xl font-bold text-gray-900">Sign in to your account</h2>
          <p className="mt-2 text-sm text-gray-500">Enter your credentials to access the platform</p>
